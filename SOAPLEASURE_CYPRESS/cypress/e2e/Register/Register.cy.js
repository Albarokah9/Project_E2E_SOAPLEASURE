...
describe('Register', () => {
  it('Register dengan data lengkap & valid', () => {
    ...
    cy.get('.alert').should(
      'contain',
      'Thank you for registering, We have sent a confirmation link to testautomation123@gmail.com'
    );
  });
  ...
  it('Register dengan password huruf & angka', () => {
    ...
    cy.get('.alert').should(
      'contain',
      'Thank you for registering, We have sent a confirmation link to test1@gmail.com'
    );
  });
  ...
  it('Register dengan konfirmasi password cocok', () => {
    ...
    cy.get('.alert').should(
      'contain',
      'Thank you for registering, We have sent a confirmation link to test2@gmail.com'
    );
  });
  ...
  it('Register dengan password kurang dari 8 karakter', () => {
    ...
    cy.get('.button').click();
    cy.wait(3000);
    cy.get(':nth-child(4) > :nth-child(1) > .form-group > .invalid-feedback')
      .should('be.visible')
  ...
  it('Register dengan konfirmasi password kosong', () => {
    ...
    cy.slowType('#password', 'abc12345');
    cy.get('.button').click();
    cy.get(':nth-child(4) > :nth-child(2) > .form-group > .invalid-feedback')
      .should('be.visible')
